...
class AboultSeeder extends Seeder{
    public function run()
    {
        DB::insert('insert into  aboults(title, description, founder,date_founder, url_image_startup, url_image_founder)vales(?,?,?,?,?,?)',['FindFer - Conectando Feirantes a clientes','<p>A <strong>FindFer</strong> é uma plataforma que visa conectar de forma fácil e inteligente, feirantes e potenciais clientes de feiras com uma ampla divulgação de feiras e produtos e crianco um contato direto dos feirantes com sues clientes.</p>
...
class ContactSeeder extends Seeder{
    public function run()
    {
        DB::insert('insert into  contacts(type,value)vales(?,?)',['Telefone','(86)988698580']);
        DB::insert('insert into  contacts(type,value)vales(?,?)',['Email','contato@findfer.com.br']);
        DB::insert('insert into  contacts(type,value)vales(?,?)',['Email','clsinfsolution@gmail.com']);
        DB::insert('insert into  contacts(type,value)vales(?,?)',['Mensagem no site','www.findfer.com.br/contacts']);
    }
}
